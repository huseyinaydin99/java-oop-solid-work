-- tüm müşteriler
SELECT *
FROM my_company_db.categories;

SELECT *
FROM my_company_db.products;

SELECT *
FROM my_company_db.customers;

SELECT *
FROM my_company_db.orders;

SELECT *
FROM my_company_db.shippings;

SELECT *
FROM my_company_db.customers;-- SOLDAKI TABLO A

SELECT *
FROM my_company_db.orders;-- SAGDAKI TABLO B
...
INNER JOIN my_company_db.orders ord ON cus."CUSTOMER_ID" = ord."CUSTOMER_ID";

-- Kolonlar için lakap kullanıyoruz
SELECT cus."CUSTOMER_ID" c_cusid
	,cus."FIRST_NAME"
	,cus."LAST_NAME"
	,ord."CUSTOMER_ID" o_cusid
	,ord."ORDER_BRANCH"
FROM my_company_db.customers cus
INNER JOIN my_company_db.orders ord ON cus."CUSTOMER_ID" = ord."CUSTOMER_ID";

-- Tablolar ve Kolonlar için lakap kullanıyoruz
SELECT c."CUSTOMER_ID" c_cusid
	,c."FIRST_NAME" c_fname
	,c."LAST_NAME" c_lname
	,o."CUSTOMER_ID" o_cusid
	,o."ORDER_BRANCH" o_branch
FROM my_company_db.customers c
INNER JOIN my_company_db.orders o ON c."CUSTOMER_ID" = o."CUSTOMER_ID";
...
-- FULL OUTER JOIN ile FULL JOIN KESİŞMEYEN ORTAK OLMAYAN KAYITLAR.
CREATE VIEW my_company_db.KESISEN_ORTAK_KAYITLAR
AS
SELECT cus."CUSTOMER_ID" c_cusid
	,cus."FIRST_NAME"
	,cus."LAST_NAME"
...
SELECT *
FROM my_company_db.KESISEN_ORTAK_KAYITLAR;

-- LEFT JOIN ile VIEW
CREATE VIEW my_company_db.LEFT_JOIN_CUSTOMER_ORDER
AS
SELECT cus."CUSTOMER_ID" c_cusid
	,cus."FIRST_NAME"
	,cus."LAST_NAME"
	...
	,ord."ORDER_BRANCH"
FROM my_company_db.customers cus
LEFT JOIN my_company_db.orders ord ON cus."CUSTOMER_ID" = ord."CUSTOMER_ID";

SELECT *
FROM my_company_db.LEFT_JOIN_CUSTOMER_ORDER;

-- RIGHT JOIN ile VIEW
CREATE VIEW my_company_db.RIGHT_JOIN_CUSTOMER_ORDER
AS
SELECT cus."CUSTOMER_ID" c_cusid
	,cus."FIRST_NAME"
	,cus."LAST_NAME"
	...
	,ord."ORDER_BRANCH"
FROM my_company_db.customers cus
RIGHT JOIN my_company_db.orders ord ON cus."CUSTOMER_ID" = ord."CUSTOMER_ID";

SELECT *
FROM my_company_db.LEFT_JOIN_CUSTOMER_ORDER;

SELECT *
FROM my_company_db.RIGHT_JOIN_CUSTOMER_ORDER;

-- VIEW ISIMLERINDE VIEW EKINI KULLANMAK DAHA IYIDIR
CREATE VIEW my_company_db.VIEW_RIGHT_JOIN_CUSTOMER_ORDER
AS
SELECT cus."CUSTOMER_ID" c_cusid
	,cus."FIRST_NAME"
	,cus."LAST_NAME"
...
-- VIEW ISIMLERINDE VIEW EKINI KULLANMAK DAHA IYIDIR
CREATE VIEW my_company_db.VIEW_LEFT_JOIN_CUSTOMER_ORDER
AS
SELECT cus."CUSTOMER_ID" c_cusid
	,cus."FIRST_NAME"
	,cus."LAST_NAME"
...
SELECT *
FROM my_company_db.VIEW_LEFT_JOIN_CUSTOMER_ORDER;

SELECT *
FROM my_company_db.VIEW_RIGHT_JOIN_CUSTOMER_ORDER;
