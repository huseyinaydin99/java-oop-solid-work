package tr.com.huseyinaydin._03_crud;
...
public class AppMain {
    ...
    public static Connection veritabaninaBaglantiKur() {
        final String DB_URL = "jdbc:mysql://localhost:3306/huseyin_aydin_db";
    ...
    public static void main(String[] args) {
        ...
        //appObj.veriEkle("Hüseyin", "AYDIN", "aaa@bbb.com", "Yönetici", "15000");
        //appObj.veriEkle("Hasan", "AYDIN", "ccc@yyy.com", "Stajyer", "1000");
        //appObj.veriEkle("Şevki", "AYDINLI", "dfsfd@yyy.com", "Uzman", "20000");
        //appObj.veriDuzenle("Veli","Kaynarca","vvv@kkk.com","CTO","35000","5");
